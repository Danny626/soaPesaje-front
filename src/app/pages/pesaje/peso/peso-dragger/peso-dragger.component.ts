...
@Component({
  selector: 'ngx-peso-dragger',
  templateUrl: './peso-dragger.component.html',
  styleUrls: ['./peso-dragger.component.scss'],
})
export class PesoDraggerComponent implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = PesoDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
